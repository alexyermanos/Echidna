...
#' hum_b_trans
#'
#' A data frame contains human B cell average gene expression for multiple cell types.
...
#' }
#'
#' @format A data frame with 33538 rows and 4 variables, with the rows representing the gene names, column names representing the cell type names.
#'
#' @source
...
#' @usage data("hum_b_trans")
"hum_b_trans"

#' hum_t_trans
#' A data frame contains human T cell average gene expression for multiple cell types, with the rows representing the gene names, column names representing the cell type names.
#' The original single cell sequencing data is retrieved from 10xgenomics and combined with experimental data from.#?
#' The expression level for different cell types are obtained by calculating the average expression after sorting the original data by markers as shown below.
#'
#' \describe{
#' \item{NaiveCd4}{CD4+;CD44-}
#' \item{MemoryCd4}{CD4+;IL7R+;CD44+}
#' \item{ActivatedCd4}{CD4+;CD44+;IL7R-;IFNG+}
#' \item{NaiveCd8}{CD8A+;TCF7+;CD44-}
#' \item{EffectorCd8}{CD8A+;CX3CR1+;IL7R-}
#' \item{MemoryCd8}{CD8A+;IL7R+;CD44+}
#' \item{ExhaustedCd8}{PDCD1+;CD8A+}
#' }
#' @format A data frame with 33538 rows and 7 variables, with the rows representing the gene names, column names representing the cell type names.
#' @source
#' https://support.10xgenomics.com/single-cell-gene-expression/datasets/3.0.0/pbmc_10k_protein_v3
#' https://support.10xgenomics.com/single-cell-gene-expression/datasets/3.0.0/pbmc_10k_v3
#' @usage data("hum_t_trans")
"hum_t_trans"
...
#' \item{ExhaustedCd8}{Pdcd1+;Cd8a+}
#' }
#' @format A data frame with 26538 rows and 7 variables, with the rows representing the gene names, column names representing the cell type names.
#' @source https://support.10xgenomics.com/single-cell-vdj/datasets
#' https://support.10xgenomics.com/single-cell-vdj/datasets/3.0.0/vdj_v1_mm_c57bl6_pbmc_5gex
#' https://support.10xgenomics.com/single-cell-vdj/datasets/3.0.0/vdj_v1_mm_balbc_pbmc_5gex
#' @usage data("mus_t_trans")
"mus_t_trans"
