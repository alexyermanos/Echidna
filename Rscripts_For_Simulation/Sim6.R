...
class_switch_prob_mus[1,2]<-0.01
class_switch_prob_mus[1,3]<-0.01
class_switch_prob_mus[1,4]<-0.01
class_switch_prob_mus[1,5]<-0.01
class_switch_prob_mus[1,6]<-0.01
class_switch_prob_mus[1,7]<-0.01
class_switch_prob_mus[1,8]<-0.01
class_switch_prob_mus[1,9]<-0.01

mix<-simulate_repertoire(initial.size.of.repertoire = 500,
